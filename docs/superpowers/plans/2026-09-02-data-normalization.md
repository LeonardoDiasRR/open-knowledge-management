...
- `python3 -m pytest tests/ -q` → **40 passed, 71 subtests passed** (baseline 18/59 + 22 new).
...
- `python3 -m pytest tests/ -q` fully green → expect **40 passed, 71 subtests passed** (the exact number the verified dry-run produced).
